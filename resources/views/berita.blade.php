                                                                        ...
                                                                        <div class="greennature-blog-grid-content">
                                                                            <header class="post-header">
                                                                                <h3 class="greennature-blog-title"><a
                                                                                        href="{{ route('berita.show', $item->slug) }}">{{ Str::limit($item->judul, 30, '...') }}</a>
                                                                                </h3>
                                                                                ...
                                                                                <div class="greennature-blog-info">
                                                                                    <div
                                                                                        ...
                                                                                        <i class="fa fa-clock-o"></i><a
                                                                                            href="{{ route('berita.show', $item->slug) }}">{{ \Carbon\Carbon::parse($item->created_at)->locale('id_ID')->isoFormat('DD MMMM YYYY') }}
                                                                                            |
                                                                            ...
                                                                            <div class="greennature-blog-content">
                                                                                ...
                                                                                <div class="clear"></div><a
                                                                                    href="{{ route('berita.show', $item->slug) }}"
                                                                                    class="excerpt-read-more">Selengkapnya</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </article>
