                    ...
                    <div class="greennature-navigation-wrapper">
                        <nav class="greennature-navigation" id="greennature-main-navigation">
                            <ul id="menu-main-menu-1" class="sf-menu greennature-main-menu">
                                <li class="menu-item menu-item-home current-menu-item greennature-normal-menu"><a href="{{ route('welcome') }}"><i class="fa fa-home"></i>Beranda</a></li>
                                @php
                                ...
                                @foreach ($menu as $item)
                                    @if ($item->sub_menu->count() > 0)
                                        {{-- has sub menu --}}
                                        <li class="menu-item menu-item-has-children greennature-normal-menu"><a href="#" class="sf-with-ul-pre"><i class="fa fa-file-text-o"></i>{{ $item->nama }}</a>
                                            <ul class="sub-menu">
                                    ...
                                    @else
                                        {{-- single menu --}}
                                        <li class="menu-item menu-item-home greennature-normal-menu"><a href="{{ $item->link }}"><i class="fa fa-file-text-o"></i>{{ $item->nama }}</a></li>
                                    @endif
                                @endforeach
                            </ul>
